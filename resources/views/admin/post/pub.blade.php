...
<h2 class="col-lg-offset-2 " style="margin-top:25px">Vous pouvez creer l'offre maintenant</h2>
...
<form action="{{route('post.store')}}" method="post"  enctype="multipart/form-data">
        ...
        <div class="form-group" style="margin-top:20px">
            ...
            <input type="Date" class="form-control" id="exampleInputDate2"  name="date_pu" placeholder="Date">
        </div>
   
    
        <div class="form-group">
            <label for="exampleInputDate1">Date fin de fin de publication</label>
            <input type="Date" class="form-control" id="exampleInputDate1"  name="date_fu" placeholder="Date">
        </div>
